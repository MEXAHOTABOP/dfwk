#based on https://raw.githubusercontent.com/NixOS/nixpkgs/master/nixos/modules/services/web-apps/mediawiki.nix
...
let
  ...
  cfg = config.services.dfwk-mediawiki;
  fpm = config.services.phpfpm.pools.dfwk-mediawiki;
  user = "mediawiki";
  ...
  mediawikiScripts = pkgs.runCommand "mediawiki-scripts" {
    ...
    for i in changePassword.php createAndPromote.php userOptions.php edit.php nukePage.php update.php; do
      makeWrapper ${cfg.php}/bin/php $out/bin/mediawiki-$(basename $i .php) \
  ...
  mediawikiConfig = pkgs.writeText "LocalSettings.php" ''
    <?php
      ...
      $wgSitename = "${cfg.name}";
      $wgMetaNamespace = "${cfg.wgMetaNamespace}";
      $wgDefaultSkin = "${cfg.wgDefaultSkin}";
      ...
      $wgLogo = "${cfg.uploadsDir}/logo.png";
      ...
      $wgPasswordSender = "${cfg.wgPasswordSender}";
      ...
      ${optionalString (cfg.smtp.enable) ''
        $wgSMTP = [
          ...
          ${if cfg.smtp.auth then ''
            "auth" => true,
            "username" => "${cfg.smtp.login}",
      ...
      $wgLanguageCode = "${cfg.wgLanguageCode}";

      $wgSecretKey = file_get_contents("/secrets/SecretKey");
...
in
{
  ...
  options = {
    services.dfwk-mediawiki = {
      ...
      wgServer = mkOption {
        type = types.str;
        default = "https://dfwk.ru";
        description = "wgServer used on wiki.";
      };

      wgMainCacheType = mkOption {
        type = types.str;
        default = "CACHE_NONE";
        example = "CACHE_ACCEL";
      ...
      wgPasswordSender = mkOption {
        type = types.str;
        default = "noreply@dfwk.ru";
        description = "wgPasswordSender used on wiki.";
      };

      wgDefaultSkin = mkOption {
        type = types.str;
        default = "monobook";
        description = "wgDefaultSkin used on wiki.";
      };

      wgMetaNamespace = mkOption {
        type = types.str;
        default = "Dwarf_Fortress_Wiki";
        description = "wgMetaNamespace used on wiki.";
      };

      wgLanguageCode = mkOption {
        type = types.str;
        default = "ru";
        description = "wgLanguageCode used on wiki.";
      };
  ...
  config = mkIf cfg.enable {
    ...
    services.phpfpm.pools.dfwk-mediawiki = {
      inherit user group;
